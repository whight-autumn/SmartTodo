...
V1.3.0 当前共有 147 项单元测试：145 项通过，2 项因当前 Windows 环境不支持创建符号链接而明确跳过，0 项失败。UI 流水线覆盖真实 Electron 主窗口、周期刷新与提醒去重、提醒时间双击保护、亮度浮层悬停桥、8 组尺寸／缩放组合，以及任务笺在 100%／125%／150% 缩放下的标签、排序、焦点、双向开关、同步、回滚和溢出行为。
